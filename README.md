...
<!--
![Screenshot mmiyounited](img/screenshot_mmiyounited.png?raw=true "MMIYounited"){imgmd}
-->
...
Clone the repository in ```$dolibarr_main_document_root_alt/mmiyounited```

```sh
cd ....../custom
git clone git@github.com:gitlogin/mmiyounited.git mmiyounited
```
